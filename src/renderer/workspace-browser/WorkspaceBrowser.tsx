...
function getWorkspaceTitle(workspaceType: CurrentWorkspaceInfo['workspaceType']): string {
  if (workspaceType === 'ayati') return `${APP_DISPLAY_NAME} Workspace`;
  return 'Workspace';
}
        ...
        <div className="workspace-content">
          {isLoading ? (
            ...
            <div className="workspace-state">
              ...
              <p>{workspaceInfo?.workspacePath ? 'The configured workspace directory does not exist.' : `Finish onboarding to create an ${APP_DISPLAY_NAME} workspace.`}</p>
            </div>
          ) : directoryError ? (
            <div className="workspace-state">
